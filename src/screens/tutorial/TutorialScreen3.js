...
import HintImage from '../game/hintImage/HintImage.js' ;
import { MainView, AlphaRow, WordView, CrossCon, GameText, GuesserView, TimerText, HintHead, GameHeader, ScoreHead, ScoreText, HeaderChild } from '../game/cssGameScreen.js' ;
...
const TutorialScreen = () => {
    const {movie, round, next, hint, config, mode, topic} = gameProps ;
    ...
    return (
        <MainView>
            ...
            <Animatable.View key={round} iterationCount={3} animation="bounce">
                <GameText> Movies : Round {round} </GameText>
            </Animatable.View>
            <GuesserView>
